...
typedef struct mqtt_qck mqtt_puback;
...
// Public communication handling functions
...
struct mqtt_suback *mqtt_packet_subback(unsigned char, unsigned short, unsigned char *, unsigned short);
